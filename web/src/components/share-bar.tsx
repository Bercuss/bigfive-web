    ...
    <>
      <Tooltip color='secondary' content='Share on facebook'>
        <Button
          ...
          as={NextUiLink}
          isExternal
          href={`https://www.facebook.com/sharer/sharer.php?u=https://swan-test.vercel.app/result/${report.id}`}
        >
      ...
      <Tooltip color='secondary' content='Share on X'>
        <Button
          ...
          target='_blank'
          as={NextUiLink}
          href={`https://twitter.com/intent/tweet?text=See my personality traits!&url=https://swan-test.vercel.app/result/${report.id}`}
        >
          <TwitterIcon size={42} />
        </Button>
      </Tooltip>
      ...
      <Tooltip color='secondary' content='Copy link'>
        <Button
          ...
          size='md'
          variant='light'
          onPress={handleCopy(`https://swan-test.vercel.app/result/${report.id}`)}
        >
          <CopyIcon size={42} />
        </Button>
      </Tooltip>
